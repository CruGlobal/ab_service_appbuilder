...
## $ docker buildx build --provenance=true --sbom=true --platform linux/amd64,linux/arm64 -t digiserve/ab-appbuilder:master --push .
...
LABEL org.opencontainers.image.title="AppBuilder" \
   org.opencontainers.image.description="Multi-tenant aware service for AppBuilder CRUD operations" \
